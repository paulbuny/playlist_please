...
function Search (props) {
  ...
  return (
    <div className="search-bar">
      <form className="search-bar__search-form" onSubmit={handleOnSubmit}>
        <input className="search-bar__search-input" type="search" placeholder="Enter your track" onChange={handleOnChange}></input>
